...
class WatchlistProvider with ChangeNotifier {
  ...
  /// [dbService] est optionnel :
  /// - null en production → WatchlistDatabaseService() réel
  /// - fourni en test → base in-memory (injection)
  ...
  bool estDansWatchlist(int serieId) => _items.any((i) => i.serie.id ==
  serieId);
